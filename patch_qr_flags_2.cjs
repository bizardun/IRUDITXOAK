...
const searchString = `                        <div className="flex gap-2.5 sm:gap-4 justify-center items-center opacity-80 print:opacity-100 pt-1 pb-1">
...
const replacement = `                        <div className="flex gap-3 sm:gap-5 justify-center items-center opacity-80 print:opacity-100 pt-2 pb-2">
