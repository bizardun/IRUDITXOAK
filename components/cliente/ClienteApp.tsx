        ...
        <div className="min-h-screen pb-16 px-4 sm:px-6 max-w-5xl mx-auto">
            <header className="pt-6 sm:pt-10 pb-4 text-center">
                {config.name.toLowerCase().includes('boliña') ? (
                    <img src="/logo boliña sin fondo.jfif" alt={config.name} className="h-16 sm:h-20 mx-auto object-contain mb-1 sm:mb-3 mix-blend-multiply contrast-150 brightness-110" />
                ) : (
